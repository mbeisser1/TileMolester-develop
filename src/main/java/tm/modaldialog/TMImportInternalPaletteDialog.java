...
public class TMImportInternalPaletteDialog extends TMModalDialog {
    ...
    protected JPanel getDialogPane() {
        ...
        TMDialogFields.configure(offsetField, 10);
        ...
        gbc.weightx = 0.2;
        buildConstraints(gbc, 1, 0, 1, 1, 20, 0);
        ...
        gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.weightx = 0.15;
        buildConstraints(gbc, 3, 0, 1, 1, 15, 0);
        ...
        gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.weightx = 1.0;
        buildConstraints(gbc, 1, 1, 2, 1, 100, 0);
        gbl.setConstraints(codecCombo, gbc);
        p.add(codecCombo);
        gbc.fill = GridBagConstraints.NONE;
        gbc.weightx = 0;
        buildConstraints(gbc, 3, 1, 1, 1, 0, 0);
        ...
        p.setPreferredSize(new Dimension(520, 150));
